...
rrdtool_font_msyhbd=$(dirname $(pwd))/trunk/static/fonts/msyhbd.ttf
rrdtool_font_msyh=$(dirname $(pwd))/trunk/static/fonts/msyh.ttf
...
/usr/local/bin/rrdtool graph ${pngfile} -w 500 -h 207 \
...
/usr/local/bin/rrdtool graph ${pngfile} -w 320 -h 102 \
-n TITLE:9:${rrdtool_font_msyhbd} \
-n UNIT:8:${rrdtool_font_msyh} \
-n LEGEND:8:${rrdtool_font_msyh} \
-n AXIS:8:${rrdtool_font_msyh} \
